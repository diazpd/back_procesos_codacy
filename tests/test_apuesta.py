...
class TestApuesta(TestCase):
    ...
    def test_obterner_apuestas(self):
        nueva_carrera = {
            "nombre": self.data_factory.sentence(),
            "competidores": [
                {
        ...
        nueva_apuesta1 = {
            "valor_apostado": random.uniform(100, 500000),
            "nombre_apostador": self.nuevo_usuario["nombre"],
            "id_competidor": id_competidor,
            "id_carrera": id_carrera
        }
        ...
        endpoint_apuestas_usuarios = endpoint_apuestas = "/apuestas/{}".format(str(self.usuario_code))

        solicitud_consulta_apuestas_despues = self.client.get(endpoint_apuestas_usuarios, headers=headers)
        total_apuestas = len(json.loads(solicitud_consulta_apuestas_despues.get_data()))

        self.assertEqual(solicitud_consulta_apuestas_despues.status_code, 200)
        self.assertEqual(total_apuestas, 1)